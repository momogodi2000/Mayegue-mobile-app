...
class EnvironmentConfig {
  ...
  static String get campayWebhookSecret => dotenv.get('CAMPAY_WEBHOOK_SECRET', fallback: '');
  ...
  static String get noupaiWebhookSecret => dotenv.get('NOUPAI_WEBHOOK_SECRET', fallback: '');

  // Base URL
  static String get baseUrl => dotenv.get('BASE_URL', fallback: 'https://mayegue.app');
